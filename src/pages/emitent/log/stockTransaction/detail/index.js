...
function Basic() {
  ...
  const printData = transactionPrint?.data
  ...
  return (
    <DashboardLayout>
      ...
      {printData && EmitentData && tid && (
        <div style={{ display: 'none' }}>
          <Transfer ref={printRef} data={printData} emitentData={EmitentData}/>
        </div>
      )}
    </DashboardLayout>
  );
